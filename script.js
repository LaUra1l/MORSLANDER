...
class Slider{
    ...
    changeSlide(className_toAdd){
        this.title.innerHTML=this.slides[this.index].title;
        this.text.innerHTML=this.slides[this.index].text;
...
class Exercises_Representation{
    ...
    create_divQuiz(className1_main, className2_logoTxt, className3_type, className4_descriptionBtn,className5_descriptionTxt, elem1, elem2, quiz) {
        ...
        desctription_btn.textContent = "OPIS";
        ...
        desctription_p.textContent = quiz.desctription;
...
const headline_nav=new Navigation('.headline','.section1',"click")
